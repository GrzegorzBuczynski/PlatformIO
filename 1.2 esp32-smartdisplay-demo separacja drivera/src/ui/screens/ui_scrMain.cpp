...
void ui_scrMain_screen_init(void)
{
    ...
    lv_obj_remove_flag(ui_GradR, (lv_obj_flag_t)(LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE));      /// Flags
    ...
    lv_obj_remove_flag(ui_GradG, (lv_obj_flag_t)(LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE));      /// Flags
    ...
    lv_obj_remove_flag(ui_GradB, (lv_obj_flag_t)(LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE));      /// Flags
