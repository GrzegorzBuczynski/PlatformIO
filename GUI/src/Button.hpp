...
public:
    ...
    uint16_t _width, _height;          // Size of the button
    String *_label;                // Label of the button
    uint16_t _outlinecolor;       // Outline color of the button
    ...
    uint8_t _fontSize;           // Font size of the button text
    ...
    Button();
    Button(uint16_t x, uint16_t y, uint16_t w, uint16_t h, String *label, uint16_t _outlinecolor, uint16_t colorOn, uint16_t colorOff, uint16_t textColor, uint8_t fontSize);
    ~Button();
};